...
class ULResourceGridAnalyzer:
    ...
    def figure_ulresourceblocks_from_ts(self, begin_ts, end_ts):
        ...
        maps = self.gnb_sched_maps_df[
            (self.gnb_sched_maps_df['sched.map.pr.timestamp'] >= begin_ts-0.010) &
